...
public class createShellFiles {
	...
	public static void main(String[] args) throws IOException{
		for(String adaptivenessType : Arrays.asList("PERFECT","PERFECT_EXTENDED","NONADAPTIVE","SEMIADAPTIVE","FULLADAPTIVE","RIGID")) {
			int cores = 10;
			...
			} else if(adaptivenessType.equals("PERFECT_EXTENDED")){
				part2 += "#BSUB -R \"rusage[mem=11000MB]\"\n" + "#BSUB -M 12GB\n" ;  
			} else {
				part2 += "#BSUB -R \"rusage[mem=5500MB]\"\n" + "#BSUB -M 6GB\n";
			}  
			part2 +=  "#BSUB -W 18:00\n\n" +
			...
			"export JAVA_HOME=/zhome/81/e/64390/LATESTJAVA/\n" +
				...
				(adaptivenessType.equals("PERFECT_EXTENDED") ?
						"export MAVEN_OPTS=-Xmx112g\n" : 
							"export MAVEN_OPTS=-Xmx56g\n")  +
			...
			System.out.println("Completed " + adaptivenessType);
		}
	}
}
